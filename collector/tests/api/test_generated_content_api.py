...
class TestGeneratedContentAPI:
    ...
    @patch("src.api.routes.generated_content.get_recent_generated_content_by_ticker")
    ...
    @patch("src.api.routes.generated_content.get_generated_content_by_company_and_ticker")
    ...
    @patch("src.api.routes.generated_content.get_generated_content")
    ...
    @patch("src.api.routes.generated_content.get_generated_content_by_hash")
