...
Focus on:
1. Interest Rate Sensitivity — fixed vs. variable rate exposure, duration, hedging instruments
2. Foreign Currency Exposure — currencies involved, translation vs. transaction risk, hedging
3. Commodity Price Risk — key commodities, contract structures, impact on margins
4. Equity Price Risk — investment portfolio exposure, mark-to-market impacts
5. Quantitative Measures — Value-at-Risk, sensitivity tables, stress test results if disclosed
