...
from symbology.api.schemas import DocumentResponse
from symbology.database.documents import get_document, get_documents_by_filing
from symbology.database.documents import get_documents_by_ids as db_get_documents_by_ids
...
async def get_document_by_accession_and_hash(accession_number: str, content_hash: str):
    ...
    try:
        ...
        from symbology.database.documents import get_document_by_accession_and_hash
