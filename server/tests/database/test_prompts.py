...
from symbology.database.generated_content import ContentSourceType, create_generated_content, GeneratedContent
...
def test_create_prompt_function(db_session, sample_user_prompt_data):
    ...
    import symbology.database.prompts as prompts_module
