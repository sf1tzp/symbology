...
def test_ingest_filing_happy_path():
    ...
    with mock.patch('symbology.ingestion.ingestion_helpers.get_10k_filing', return_value=mock_filing) as mock_get_filing, \
         ...
         mock.patch('symbology.ingestion.ingestion_helpers._year_from_period_of_report', return_value=2022) as _mock_get_year:
...
def test_ingest_filing_not_found():
    ...
    with mock.patch('symbology.ingestion.ingestion_helpers.get_10k_filing', return_value=None) as _mock_get_filing, \
         mock.patch('symbology.ingestion.ingestion_helpers.logger') as mock_logger:
...
def test_ingest_filing_error_handling():
    ...
    with mock.patch('symbology.ingestion.ingestion_helpers.get_10k_filing',
