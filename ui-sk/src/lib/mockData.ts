...
Looking forward, the company is well-positioned for continued growth with strong fundamentals, robust cash position, and clear strategic direction. Management expects continued revenue growth in the range of 10-15% for the upcoming fiscal year.`,
	summary:
		'Comprehensive financial analysis showing strong performance with 15% revenue growth, improved margins, and successful market expansion. Digital transformation and product innovation remain key strategic priorities.',
...
export const mockCompany: MockCompany = {
	...
	summary:
		'Apple Inc. is a leading technology company that designs, develops and sells consumer electronics, computer software and online services...'
};
